...
#ifndef EQUILIBRE_CORE_FRAGMENTS_H
#define EQUILIBRE_CORE_FRAGMENTS_H
...
/*!
  \brief This type of fragment (0x29) defines placeable light sources.
  */
class RegionTypeFragment : public WLDFragment
{
public:
    virtual bool unpack(WLDReader *s);

    const static uint16_t KIND = 0x29;
    uint32_t m_flags;
    QVector<uint32_t> m_regions;
    QVector<uint8_t> m_extra;
};
